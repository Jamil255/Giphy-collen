...
const GifPage = () => {
  ...
  const shareGif = () => {
    if (navigator.share) {
      ...
      alert(
        'Your browser does not support the Web Share API. Please copy the URL manually.'
      )
    }
  }

  const EmbedGif = () => {
    const embedUrl = `<iframe src="${gif.embed_url}" width="480" height="270" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>`
    navigator.clipboard
      .writeText(embedUrl)
